<div class="articles-landing-page">
  <div class="title">
    <h1><i class="fas fa-fw fa-newspaper"></i> Articles</h1>
    <div class="form ui">
    ...
    <div class="articles">
      @forelse($articles as $article)
        ...
        <div class="article">
          ...
          @auth
            @if (!\App\Models\FavArticles::is_added_before($article->article_id, id()))
              <div class="bookmarks-ar" wire:click="add_to_favs('{{ $article->article_id }}')">

                <i class="far fa-fw fa-bookmark fa-2x add-to-book"></i>
              </div>
            @else
              <div class="bookmarks-ar" wire:click="remove_from_favs('{{ $article->article_id }}')">
                <i class="fas fa-fw fa-bookmark fa-2x remove-from-book" wire:click="remove_from_favs('{{ $article->article_id }}')"></i>
