...
@section('title', 'Restore All Articles')

@section('content')

  <div class="section">
    <h1 class="heading _300"><i class="fas fa-fw fa-trash"></i> Restore All Howto Articles </h1>
    <div class="confirmation-message">
      ...
      <form method="post">
        ...
        <a class="ui button primary" href="{{ route('admin.howto') }}"><i class="fas fa-fw fa-times"></i> Cancel</a>
      </form>
    </div>
  </div>
