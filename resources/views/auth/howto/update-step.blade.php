...
@section('title', 'Update Step | ' . $step->step_title)
@section('content')
  ...
  <div class="profile-page">
    ...
    <div class="add-section add-new-lecture-course second-section">
      ...
      <h1 class="heading"><i class="fas fa-fw fa-play"></i> Add New Step to "{{ $step->step_title }}"</h1>
      ...
      <form method="post" class="add-article-form ui form" enctype="multipart/form-data">
        ...
        <div class="field">
          ...
          <textarea name="step_content" id="editor">{{ $step->step_content }}</textarea>
